(function(){
  ...
  window.S3Direct = function (el, options) {
    ...
    function request(method, url, data, headers, el, showProgress, cb) {
    ...
    function progressBar(el, data, showProgress) {
      if (data.lengthComputable === false || showProgress === false) {
        return
      }
